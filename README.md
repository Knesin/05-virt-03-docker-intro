...
# Домашнее задание к занятию 4 «Оркестрация группой Docker контейнеров на примере Docker Compose» - Клочек Максим
...
- Файлы в папке [src/task1](src/task1)
- Команды
  - `docker build -t makskl/custom-nginx:1.0.0 .`
  - `docker login`
  - `docker push makskl/custom-nginx:1.0.0`
- Ссылка https://hub.docker.com/repository/docker/makskl/custom-nginx/general
---
